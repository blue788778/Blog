    ...
    var o = {
        ...
        navbarChange: function() {
            e(n).scroll(function() {
                ...
                // 標題不在頂端時
                if (150 < t){
                    if(darkModeChange == false){
                        (e("nav").removeClass("navbar-transparent"), e("body").addClass("not-on-top"));
                        (e("body").removeClass("not-on-topDark"));
                        setStyle("");
                    }
                    else{
                        (e("nav").removeClass("navbar-transparent"), e("body").addClass("not-on-topDark"));
                ...
                // 標題在頂端時
                    ...
                    if(darkModeChange == false){
                        (e("body").removeClass("not-on-top"), e("nav").addClass("navbar-transparent"));
                    }
                    else{
                        console.log(darkModeChange);
                        (e("body").removeClass("not-on-topDark"), e("nav").addClass("navbar-transparent"));
                    }
